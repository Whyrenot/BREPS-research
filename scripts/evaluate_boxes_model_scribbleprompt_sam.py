...
from isegm.model.is_scribbleprompt_model_sam import ISModelScribblePrompt
...
from evaluate_boxes_model_sam import parse_args
...
def main():
    ...
    for dataset_name in args.datasets.split(','):
        ...
        for checkpoint_path in checkpoints_list:
            model = ISModelScribblePrompt(device=args.device, scribble_weights_path=checkpoint_path)
            ...
            predictor = get_predictor(model, args.mode, args.device,prompt_modality= args.modality,
                                      ...
                                      zoom_in_params=zoomin_params, with_flip=False, model_name='scribble')
