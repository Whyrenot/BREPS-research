import sys
import os
os.environ["CUDA_VISIBLE_DEVICES"] = "2, 3"  # Only make the 3rd GPU (index 2) visible
sys.path.insert(0, '.')
...
from isegm.model.is_mobilesam_model import ISModelMobileSAM
...
def main():
    ...
    for dataset_name in args.datasets.split(','):
        ...
        for checkpoint_path in checkpoints_list:
            model = ISModelMobileSAM(device=args.device, model_path=checkpoint_path)
