...
from isegm.model.is_sammed2d_model import ISModelSAMMed2d
...
def main():
    ...
    for dataset_name in args.datasets.split(','):
        ...
        for checkpoint_path in checkpoints_list:
            model = ISModelSAMMed2d(device=args.device, model_path=checkpoint_path)
            ...
            predictor = get_predictor(model, args.mode, args.device,prompt_modality= args.modality,
                                      ...
                                      zoom_in_params=zoomin_params, with_flip=False, model_name='sammed')
