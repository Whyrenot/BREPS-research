...
class DSample:
    def __init__(self, image, encoded_masks, objects=None,
                 objects_ids=None, ignore_ids=None, sample_id=None, imname=None):
        self.image = image
...
class DSampleWithPrompt(DSample):
    def __init__(self, image, encoded_masks, prompt_positive=None, prompt_negative=None,maskname:str=None, **kwargs):
        super(DSampleWithPrompt, self).__init__(image, encoded_masks, **kwargs)
        self._prompt_positive = prompt_positive
        self._prompt_negative = prompt_negative
        self.maskname = maskname
    @property
    def prompt_positive(self):
        return self._prompt_positive
    @property
    def prompt_negative(self):
        return self._prompt_negative
